...
If you are encountering this error on the public Payshares infrastructure, please report an error on [Horizon's issue tracker](https://github.com/payshares/horizon/issues) and include the instance attribute.
...
```json
{
  "type":     "https://www.payshares.org/docs/horizon/problems/server_error",
  "title":    "Internal Server Error",
  "status":   500,
  "details":  "...",
