...
```shell
$ curl -X GET "https://horizon-testnet.payshares.org/ledgers/200/effects"
{
  ...
  "instance": "horizon-testnet-001.prd.payshares001.internal.payshares-ops.com/hCYL7oezXs-141917"
}
```
