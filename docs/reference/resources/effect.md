...
directly reflected in the [ledger](https://www.payshares.org/developers/learn/concepts/ledger.html) or [history](https://github.com/payshares/payshares-core/blob/master/docs/history.md), as [transactions](https://www.payshares.org/developers/learn/concepts/transactions.html) and [operations](https://www.payshares.org/developers/learn/concepts/operations.html) are.
