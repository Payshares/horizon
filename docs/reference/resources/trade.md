...
Trades can also be caused by successful [path payments](https://www.payshares.org/developers/learn/concepts/exchange.html), because path payments involve fulfilling offers.
