...
Accounts on the Payshares network can make [offers](http://payshares.org/developers/learn/concepts/exchange.html) to buy or sell assets.  Users can create offers with the [Manage Offer](http://payshares.org/developers/learn/concepts/list-of-operations.html) operation.
