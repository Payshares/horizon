...
title: All Ledgers
clientData:
  laboratoryUrl: https://www.payshares.org/laboratory/#explorer?resource=ledgers&endpoint=all
---

This endpoint represents all [ledgers](../resources/ledger.md).
This endpoint can also be used in [streaming](../responses.md#streaming) mode so it is possible to use it to get notifications as ledgers are closed by the Payshares network.
...
curl "https://horizon-testnet.payshares.org/ledgers?limit=200&order=desc"
```
