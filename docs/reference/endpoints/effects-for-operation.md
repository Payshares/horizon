...
clientData:
  laboratoryUrl: https://www.payshares.org/laboratory/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://horizon-testnet.payshares.org/operations/77309415424/effects"
```
