...
clientData:
  laboratoryUrl: https://www.payshares.org/laboratory/#explorer?resource=operations&endpoint=single
---
...
```sh
curl https://horizon-testnet.payshares.org/operations/77309415424
```
