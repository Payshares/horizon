...
PACKAGES=$(find src/github.com/payshares/horizon/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find src/github.com/payshares/horizon/test/scenarios -iname 'kahuna.rb')
...
export PAYSHARES_CORE_DATABASE_URL="postgres://localhost/hayashi_scenarios?sslmode=disable"
export DATABASE_URL="postgres://localhost/horizon_scenarios?sslmode=disable"
export NETWORK_PASSPHRASE="Test SDF Network ; September 2015"
export PAYSHARES_CORE_URL="http://localhost:8080"
...
gb generate github.com/payshares/horizon/test/scenarios
# gb test github.com/payshares/horizon/ingest
