...
import (
	...
	"github.com/payshares/horizon/resource/base"
	"github.com/payshares/horizon/resource/effects"
	"github.com/payshares/horizon/resource/operations"
...
type Root struct {
	...
	PaysharesCoreVersion   string `json:"core_version"`
