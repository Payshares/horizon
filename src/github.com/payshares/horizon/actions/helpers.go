...
// GetAddress retrieves a payshares address.  It confirms the value loaded is a
// valid payshares address, setting an invalid field error if it is not.
...
// the string at the provided name in accordance with the payshares client
// conventions
