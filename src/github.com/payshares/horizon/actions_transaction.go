...
// TransactionCreateAction submits a transaction to the payshares-core network
...
func (action *TransactionCreateAction) loadResource() {
	...
	case *txsub.FailedTransactionError:
		...
		action.Err = &problem.P{
			...
			Detail: "The transaction failed when submitted to the payshares network. " +
				"The `extras.result_codes` field on this response contains further " +
				"details.  Descriptions of each code can be found at: " +
				"https://www.payshares.org/developers/learn/concepts/list-of-operations.html",
