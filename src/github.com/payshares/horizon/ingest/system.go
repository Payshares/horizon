...
// run causes the importer to check payshares-core to see if we can import new
// data.
...
// horizon but is no longer present in the payshares-core database source.  The
// usual cause for this situation is a payshares-core that uses the CATCHUP_RECENT
// mode.
