...
func initDbMetrics(app *App) {
	...
	app.metrics.Register("payshares_core.latest_ledger", app.coreLatestLedgerGauge)
	app.metrics.Register("payshares_core.elder_ledger", app.coreElderLedgerGauge)
	app.metrics.Register("history.open_connections", app.horizonConnGauge)
	app.metrics.Register("payshares_core.open_connections", app.coreConnGauge)
