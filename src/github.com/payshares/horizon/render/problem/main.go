...
import (
	...
	"github.com/payshares/horizon/context/requestid"
...
func Inflate(ctx context.Context, p *P) {
	...
	p.Type = "https://payshares.org/horizon-errors/" + p.Type
...
var (
	...
	ServerError = P{
		...
		Detail: "An error occurred while processing this request.  This is usually due " +
			...
			"to the issue tracker at: https://github.com/payshares/horizon/issues." +
	...
	BeforeHistory = P{
		...
		Detail: "This horizon instance is configured to only track a " +
			"portion of the payshares network's latest history. This request " +
	...
	StaleHistory = P{
		...
		Detail: "This horizon instance is configured to reject client requests " +
			...
			"behind the connected instance of payshares-core.  If you operate this " +
